...
/**
 * La classe {@code Console} fournit des méthodes utilitaires pour faciliter les interactions avec
 * la console en Java. Elle permet de lire des entrées utilisateur, d'afficher des messages, et de
 * gérer la redirection des flux d'entrée/sortie.
 *
 * <p>
 * Cette classe utilise un {@link Scanner} pour lire les entrées et un {@link PrintStream} pour
 * écrire les sorties. Elle est conçue pour simplifier les opérations courantes de lecture et
 * d'écriture en console.
 * </p>
 *
 * <p>
 * <strong>Exemple d'utilisation basique :</strong>
 * </p>
 * 
 * <pre>
...
public class Console {
  ...
  /**
   * Lit un entier depuis la console. En cas d'erreur de saisie, l'utilisateur est invité à réessayer
  ...
  /**
   * Lit un nombre flottant depuis la console. En cas d'erreur de saisie, l'utilisateur est invité à
   * réessayer jusqu'à ce qu'une valeur valide soit entrée.
   *
   * @param message Le message à afficher avant de lire l'entrée (peut être {@code null}).
