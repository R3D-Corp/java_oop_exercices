...
package labs.math.matrices_bits.graphics;
...
//            Scanner input = new Scanner(url.openStream());
            ...
            // Jdk21
			URI uri = URI.create(COURSE_WEB_SITE);
			URL url = uri.toURL();	
			Scanner input = new Scanner(url.openStream());
...
//        }
        ...
        public void setImage1(String filename) throws IOException {
            ...
            if (filename.startsWith("http")) {
            // JDK 21 : remplacer new URL(...) par URI.create(...).toURL()
                URI uri = URI.create(filename);              // doit être absolue et bien encodée
...
//        }
        ...
        public void setImage2(String filename) throws IOException {
            if (filename.startsWith("http")) {
                // JDK 21 : remplacer new URL(...) -> URI.create(...).toURL()
                URI uri = URI.create(filename);          // doit être une URI absolue et correctement encodée
